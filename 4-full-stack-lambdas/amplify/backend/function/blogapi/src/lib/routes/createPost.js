...
var createPost = {
  ...
  handler: function () {
    var _handler = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
      var newPost, _yield$Post$insertOne, insertedId, posts;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return Post.insertOne(newPost);

            case 3:
              _yield$Post$insertOne = _context.sent;
              insertedId = _yield$Post$insertOne.insertedId;
              _context.next = 7;
              return Post.getAll();
